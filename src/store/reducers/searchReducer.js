...
const initialState = {
  responses: {
    ...
    //     "id": "id655232-rzp-ooo",
    //     "name": "RZP (ООО) ",
    //     "type": "Компания ООО «RZP» специализируется на строительстве, ремонте, демонтаже и обслуживании железных дорог. "
    //   },
    //   {
    //     "bench": 0,
    //     "allSees": "11301",
    //     "city": "Новочеркасск",
    //     "id": "id59884-almaz-tm-tens-ooo",
    //     "name": "АЛМАЗ (ТМ ТЭНС), ООО ",
    //     "type": "Разработка и производство пылевлагозащищенных светодиодных светильников (IP54, IP65, IP67) и АСУНО."
    //   },
    //   {
    //     "bench": 0,
    //     "allSees": "8704",
    //     "city": "Екатеринбург",
    //     "id": "id42322-ekspertniy-tsentr-tehnologicheskih-resheniy-ooo",
    //     "name": "Экспертный центр технологических решений, ООО",
    //     "type": "Разработки, Производство. поставка, сервис, ремонтные работы, запасные части."
    //   },
    //   {
    //     "bench": 0,
    //     "allSees": "3334",
    //     "city": "Санкт-Петербург",
    //     "id": "id583702-alternativnaya-energiya-spb-ooo",
    //     "name": "Альтернативная Энергия СПб, ООО",
    //     "type": "Котлы индукционные отопительные нового поколения - новый вид отопительного оборудования, КПД-98%"
    //   },
    //   {
    //     "bench": 0,
    //     "allSees": "4428",
    //     "city": "Тула",
    //     "id": "id49213-bdt-agro-ooo",
    //     "name": "БДТ-АГРО, ООО",
    //     "type": "ООО «БДТ-АГРО» является разработчиком и ЗАВОДОМ-ИЗГОТОВИТЕЛЕМ почвообрабатывающей техники."
    //   }
    // ],
  },
  //     [
